// Command dotimport-cryptossh dot-imports "golang.org/x/crypto/ssh", one of the four import paths the
...
// NewClient is ssh.NewClient with the qualifier stripped off.
var _ = NewClient
